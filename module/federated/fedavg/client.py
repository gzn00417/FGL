...
from module.federated.base import ClientModule
...
class Client(ClientModule):
    ...
    def __init__(self, args, w_id, g_id, sd):
        ...
        self.model = globals()[args.model](self.args.n_feat, self.args.n_dims, self.args.n_clss, self.args).cuda(g_id)
    ...
    def load_state(self):
        loaded = torch.load(os.path.join(self.args.checkpt_path, f'{self.client_id}_state.pt'), map_location=torch.device('cpu'))
